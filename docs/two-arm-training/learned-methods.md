...
[the single-arm versions](../one-arm-training/learned-methods.md) of these methods.
...
[the cooperative control formulations](programmed-methods.md#5-feedback-control-and-the-closed-chain)
...
([HIL-SERL, 100% on every task after one to two and a half hours](../one-arm-training/learned-methods.md#12-interactive-imitation-correcting-it-as-it-goes))
...
Next: back to [the overview](overview.md), or to
[the programmed methods](programmed-methods.md) for the control theory the learned
