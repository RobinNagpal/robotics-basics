...
[the single-arm versions](../07_one-arm-training/02_programmed-methods.md) of these
...
With two arms the appeal of [TAMP](../07_one-arm-training/02_programmed-methods.md#5-task-and-motion-planning)
