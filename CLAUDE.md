...
```
docs/07_one-arm-training/01_overview.md
docs/07_one-arm-training/02_programmed-methods.md
docs/05_camera/03_one-box-intro.md
docs/09_stone-stacking.md
```
...
- Image folders are named after the *document* they belong to, without its number:
  ...
  `docs/07_one-arm-training/01_overview.md`. This keeps image paths stable when a
