...
[Section 7](#7-projects-that-look-open-but-are-not) lists the ones that fail,
and why, because knowing that is half the skill.

Everything below was checked on 2026-09-17, and
[section 10](#10-what-was-checked-and-when) says what was run here versus what
was only read.
...
5. [Every project at a glance](#5-every-project-at-a-glance)
6. [What runs on this Mac, and what needs a Linux box](#6-what-runs-on-this-mac-and-what-needs-a-linux-box)
7. [Projects that look open but are not](#7-projects-that-look-open-but-are-not)
8. [Pitfalls that cost days](#8-pitfalls-that-cost-days)
9. [How this repo's areas connect](#9-how-this-repos-areas-connect)
10. [What was checked, and when](#10-what-was-checked-and-when)
...
## 6. What runs on this Mac, and what needs a Linux box
...
## 7. Projects that look open but are not
...
- **[The arm area](arm/overview.md)** — frames and transforms. With two arms
...
- **[The camera area](camera/basics.md) and
  [finding objects](camera/finding-objects.md)** — every policy above eats
...
step rates in [section 6](#6-what-runs-on-this-mac-and-what-needs-a-linux-box),
