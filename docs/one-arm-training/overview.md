...
**[Learned methods](learned-methods.md).** The behaviour that comes from data:
...
There is also a companion folder, **[two-arm training](../two-arm-training/overview.md)**,
...
they are solved — solved by [the programmed methods](programmed-methods.md), and
...
**[What is changing, and why](what-is-changing.md)** is the full treatment of all of
...
- [ROS basics](../ros/ros-basics.md) is the plumbing that every method above runs on.
...
- [Stone stacking](../stone-stacking.md) and
  [full training](../full-training/overview.md) take a single task and work it
