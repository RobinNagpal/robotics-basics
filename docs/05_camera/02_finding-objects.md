...
[ROS camera doc](../01_ros/03_ros-camera.md#2-the-cameras-two-message-classes)
...
[camera basics](01_basics.md#4-getting-distance-back-the-depth-picture) explain how
...
[NumPy doc](../04_numpy/01_numpy-intro.md#42-boolean-masks) explains masks.
...
[one-box intro](03_one-box-intro.md#11-pixel-plus-depth-gives-back-the-point) works
...
[section 1.2 of the one-box intro](03_one-box-intro.md#12-where-the-camera-is).
...
- [Camera basics](01_basics.md) — what a picture is, what it loses, what a depth
  picture adds, and where the four lens numbers come from.
- [Locating a single box: the idea](03_one-box-intro.md) — the same arithmetic as
...
- [Locating a single box: the code](04_one-box-code.md) — the ROS version of all
  ...
  what it found.
- [ROS camera](../01_ros/03_ros-camera.md) — the messages a camera sends, and the
  smallest node that receives them.
- [NumPy for robotics](../04_numpy/01_numpy-intro.md) — masks, medians and the
