...
[one-box doc](03_one-box-intro.md) then uses these basics to find a box on a table and
measure it.
...
[one-box doc](03_one-box-intro.md) uses those numbers to get the missing information
...
[one-box doc](03_one-box-intro.md#13-what-one-capture-contains) explains them.)
...
enough to pin down a point in 3D, and the [one-box doc](03_one-box-intro.md) turns that
into arithmetic.
...
doc](03_one-box-intro.md#11-pixel-plus-depth-gives-back-the-point) measures is 0.1894
...
Next: [finding one box](03_one-box-intro.md), which uses these basics to measure the box.

Also in this area: [finding an object in a picture](02_finding-objects.md), the
...
Previous area: [position, frames and transforms](../03_arm/01_overview.md).
