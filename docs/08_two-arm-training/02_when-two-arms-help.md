...
[one arm and a fixture](../07_one-arm-training/01_overview.md). The rest of the folder is
...
by running [the one-arm methods](../07_one-arm-training/01_overview.md) twice, and the
...
this folder and in
[the one-arm documents](../07_one-arm-training/01_overview.md#1-what-an-arm-is-actually-asked-to-do).
...
6. **Otherwise: one arm and a fixture.** Read
   [the one-arm documents](../07_one-arm-training/01_overview.md) and spend the saved
...
[the one-arm documents](../07_one-arm-training/01_overview.md) if the checklist sent you
back there.
