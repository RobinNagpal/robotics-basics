...
**[Two-arm manipulation](docs/12_two-arm-manipulation.md)** is a route into
...
**[Stone stacking](docs/11_stone-stacking.md)** takes one hard two-arm task —
...
**[Full training](docs/13_full-training/01_overview.md)** follows one branch of that
...
**[One-arm training](docs/09_one-arm-training/01_overview.md)** is the map above all of
...
Two companions to it: **[a learning path](docs/09_one-arm-training/04_learning-path.md)**
...
and
**[what is changing, and why](docs/09_one-arm-training/05_what-is-changing.md)** explains
the direction of travel and the reasons behind it, which outlast any particular
model name. There is also a
**[glossary](docs/09_one-arm-training/06_glossary.md)** covering every term in that
folder, from what a degree of freedom is to what ACT and diffusion policy are.

**[A case study](docs/09_one-arm-training/07_case-study/01_place-glass.md)** in the same
...
**[Two-arm training](docs/10_two-arm-training/01_overview.md)** is the companion folder
