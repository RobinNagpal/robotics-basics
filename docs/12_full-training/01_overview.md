...
The [stone stacking doc](../10_stone-stacking.md) offers three ways to build the
...
[collecting the data](02_collecting-data.md) is phases 1 to 3, and
[training and evaluating](03_training-and-evaluating.md) is phases 4 and 5.
...
| a way to drive both arms by hand | this is what produces the data, and it is the part people underestimate | see [collecting the data](02_collecting-data.md#2-how-a-person-drives-two-arms) |
| a few hundred demonstrations | a policy can only copy what it has seen | a scripted expert can stand in for a person; same doc, [section 3](02_collecting-data.md#3-the-fork-a-person-or-a-program) |
...
[stone stacking doc suggests](../10_stone-stacking.md#6-programmed-or-trained) and
as the [survey of methods](../08_one-arm-training/01_overview.md#9-what-real-systems-actually-do)
...
Next: [collecting the data](02_collecting-data.md).
