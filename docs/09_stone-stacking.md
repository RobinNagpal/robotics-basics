...
[two-arm doc](10_two-arm-manipulation.md), whichever your simulator already has.
...
[two-arm doc](10_two-arm-manipulation.md#1-what-the-second-arm-adds):
...
they compare, see
[ways to programme or train two arms](08_two-arm-training/01_overview.md).)
...
[two-arm doc's step 2](10_two-arm-manipulation.md#42-step-2-copy-demonstrations)
...
[full-training folder](11_full-training/01_overview.md) follows this route all the
...
[two-arm doc](10_two-arm-manipulation.md#3-how-to-work-through-a-step).
...
[two-arm manipulation doc](10_two-arm-manipulation.md), which lists the open
