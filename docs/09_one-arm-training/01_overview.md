...
There is also a companion folder, **[two-arm training](../10_two-arm-training/01_overview.md)**,
...
- [Stone stacking](../11_stone-stacking.md) and
  [full training](../13_full-training/01_overview.md) take a single task and work it
  through the programmed way and then the trained way.
- [Two-arm training](../10_two-arm-training/01_overview.md) is the companion folder for
