...
The [ROS intro](ros-intro.md) explains the ideas; this doc shows each of them on
...
[ROS camera](ros-camera.md), [ROS arm](ros-arm.md) and
[ROS camera and arm](ros-camera-arm.md).
...
looks it up. The [arm area](../arm/overview.md) explains what a transform
...
[ROS camera](ros-camera.md), then [ROS arm](ros-arm.md), then
[ROS camera and arm](ros-camera-arm.md).
