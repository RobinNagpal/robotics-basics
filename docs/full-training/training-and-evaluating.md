...
This is phases 4 and 5 of the [overview](overview.md): turning the dataset from
[collecting the data](collecting-data.md) into a policy, and then finding out
...
[two-arm doc](../two-arm-manipulation.md#44-step-4-measure-generalisation),
...
[overview](overview.md#2-the-five-phases), and the rule is that **the data is
what you change**.
...
Back to [the overview](overview.md), or out to
[stone stacking](../stone-stacking.md), which this folder is one branch of.
