...
Read [the overview](01_overview.md) first if you have not already, and ideally
[the programmed methods](02_programmed-methods.md) as well, because almost everything
...
[the programmed methods](02_programmed-methods.md) — and you replace only the parts
...
[what changes with two arms](../09_two-arm-training/01_overview.md).
