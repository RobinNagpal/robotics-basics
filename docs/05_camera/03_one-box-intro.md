...
This doc builds on [the basics](01_basics.md), which explain what a camera records
...
The [code doc](04_one-box-code.md) then writes the same calculations as pseudo code
...
[The basics](01_basics.md) showed that each pixel gives a direction, and that the
...
basics](01_basics.md#3-what-a-picture-loses) showed that a pixel tells us a
...
basics](01_basics.md#4-getting-distance-back-the-depth-picture) explained. Once we
...
[section 4 of the basics](01_basics.md#4-getting-distance-back-the-depth-picture)
...
in pixels, which [section 6 of the basics](01_basics.md#6-the-lens-as-four-numbers)
...
[section 6 of the basics](01_basics.md#6-the-lens-as-four-numbers), which point the
...
| `cx` | the middle of the picture, across | the four lens numbers ([section 6 of the basics](01_basics.md#6-the-lens-as-four-numbers)) | 160 |
...
basics](01_basics.md#3-what-a-picture-loses), written as a number: it says that the
...
of the basics](01_basics.md#7-field-of-view-and-resolution-are-separate-knobs),
...
basics](01_basics.md#4-getting-distance-back-the-depth-picture) pays off. The depth
...
basics](01_basics.md#6-the-lens-as-four-numbers), which starts from a point and
...
[code doc](04_one-box-code.md), as [pseudo
code](04_one-box-code.md#11-one-pixel-into-one-point) and as
[Python](04_one-box-code.md#32-one-pixel-into-one-point).
...
This is the same idea as a transform in the [arm area](../03_arm/01_overview.md): a
...
doc](04_one-box-code.md#42-the-cameras-two-frames) explains.
...
basics](01_basics.md#5-the-cameras-used-in-these-docs), gives only the first two
...
publishes it for the rest of the robot. The [code doc](04_one-box-code.md) shows
...
Next: [the code](04_one-box-code.md), which does these calculations in Python.

Previous: [the basics](01_basics.md), which explain what a camera records and the
