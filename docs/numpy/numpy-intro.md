...
give NumPy arrays (the [tools and libraries](../tools-and-libraries.md) doc has
...
row ([ROS camera, section 2.1](../ros/ros-camera.md#21-image-one-picture)).
...
[arm area](../arm/overview.md) explains the ideas; this section shows the NumPy
...
[one-box intro](../camera/one-box-intro.md#12-where-the-camera-is).

### 6.4 The camera matrix k

The camera's lens is the 3 × 3 matrix k, which ROS sends in every CameraInfo
message ([ROS camera, section 2.3](../ros/ros-camera.md#23-k-in-detail-what-it-is-why-the-camera-sends-it-and-who-reads-it)).
...
[section 1.1 of the one-box intro](../camera/one-box-intro.md#11-pixel-plus-depth-gives-back-the-point).
...
[ROS intro explains in section 2](../ros/ros-intro.md#2-nodes-topics-and-messages).
