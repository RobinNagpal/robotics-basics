...
[arm area](03_arm/01_overview.md). Link 1 is 3 m and link 2 is 2 m. At 30° and 60°, its
...
**What it is.** TF2 keeps track of frames, and the [rviz](02_rviz/01_overview.md) and
[arm](03_arm/01_overview.md) areas cover it in detail. **robot_state_publisher** is
...
[rviz area](02_rviz/01_overview.md) of this repo is all about it.
...
- **Camera drivers** publish what the camera sees, as the same topics the
  [camera area](05_camera/04_one-box-code.md#43-the-topics) uses: colour, depth, the four lens
...
| Route | Section |
| --- | --- |
| by hand, joining transforms | [arm area](03_arm/01_overview.md) |
