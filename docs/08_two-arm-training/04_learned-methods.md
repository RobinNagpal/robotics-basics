...
[the single-arm versions](../07_one-arm-training/03_learned-methods.md) of these methods.
...
[collecting the data](../11_full-training/02_collecting-data.md#2-how-a-person-drives-two-arms).
...
([HIL-SERL, 100% on every task after one to two and a half hours](../07_one-arm-training/03_learned-methods.md#12-interactive-imitation-correcting-it-as-it-goes))
