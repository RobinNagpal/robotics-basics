...
[the one-arm methods](../09_one-arm-training/01_overview.md) twice and keeping the arms
apart.

**Read the one-arm documents first**, including
[what is changing and why](../09_one-arm-training/05_what-is-changing.md) for the
...
[the one-arm overview](../09_one-arm-training/01_overview.md#3-the-four-layers-of-an-arm-system):
...
[the one-arm grid](../09_one-arm-training/01_overview.md#5-which-method-for-which-task),
...
[the single-arm version](../09_one-arm-training/01_overview.md#8-what-each-method-costs-you)
already demanded.
...
[the one-arm overview](../09_one-arm-training/01_overview.md#10-what-you-can-realistically-do-in-the-next-year)
