...
Read [the overview](01_overview.md) first if you have not already, because it sets out
...
[the overview's task catalogue](01_overview.md#1-what-an-arm-is-actually-asked-to-do).
...
[directed by language](03_learned-methods.md#5-directed-by-language) — and even where a
...
[arm area](../03_arm/01_overview.md) — and a model of the surroundings, which usually
...
there. This is the subject of this repository's [arm area](../03_arm/01_overview.md), and
...
pattern, covered in
[learned pieces inside a programmed system](03_learned-methods.md#4-learned-pieces-inside-a-programmed-system),
...
Next: [learned methods](03_learned-methods.md), or back to
