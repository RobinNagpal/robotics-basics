...
[one-box intro](03_one-box-intro.md) explains the problem and does the calculations
...
intro](03_one-box-intro.md#1-calculations) without the explanations, so that the
...
intro](03_one-box-intro.md#11-pixel-plus-depth-gives-back-the-point), in the same
...
intro](03_one-box-intro.md#12-where-the-camera-is). It starts from the point that
...
intro](03_one-box-intro.md#14-the-box-measured). It runs the two pieces above for
...
2](../01_ros/01_ros-intro.md#2-nodes-topics-and-messages). `msg: Image` says that the
...
[one-box intro](03_one-box-intro.md#11-pixel-plus-depth-gives-back-the-point) for
...
intro](03_one-box-intro.md#11-pixel-plus-depth-gives-back-the-point) out one line
at a time, so that each step can be seen and checked on its own. It uses the
same numbers as [section 1.1 of the
intro](03_one-box-intro.md#11-pixel-plus-depth-gives-back-the-point), and it prints
the same answer.
...
walk from [section 1.2 of the intro](03_one-box-intro.md#12-where-the-camera-is)
...
intro](03_one-box-intro.md#12-where-the-camera-is), with the height of the box as
its last number:
...
[section 1.3 of the intro](03_one-box-intro.md#13-what-one-capture-contains).

### 3.5 Measuring the box

This last piece is the whole job from [section 1.4 of the
intro](03_one-box-intro.md#14-the-box-measured), and it follows the four steps of
...
intro](03_one-box-intro.md#12-where-the-camera-is) by `transform_matrix()`.
...
intro](03_one-box-intro.md#14-the-box-measured) and prints the answer:
...
[Section 6 of the basics](01_basics.md#6-the-lens-as-four-numbers) gave the
...
[section 5 of the basics](01_basics.md#5-the-cameras-used-in-these-docs) is not
...
Previous: [the one-box intro](03_one-box-intro.md), which does the calculations this
code carries out.
