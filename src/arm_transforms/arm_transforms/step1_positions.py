...
With ``L1 = 3`` and ``q1 = 30``, that is ``(3*0.866, 3*0.5)``, or
``(2.598, 1.5)``. Turn the same link to 60 degrees and the two swap round, to
``(1.5, 2.598)``, because ``cos`` and ``sin`` trade places between the two.
