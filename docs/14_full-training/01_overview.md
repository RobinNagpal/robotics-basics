...
The [stone stacking doc](../12_stone-stacking.md) offers three ways to build the
...
[stone stacking doc suggests](../12_stone-stacking.md#6-programmed-or-trained) and
as the [survey of methods](../10_one-arm-training/01_overview.md#9-what-real-systems-actually-do)
