...
**[When two arms are really useful](when-two-arms-help.md).** Whether your task
...
**[Programmed methods](programmed-methods.md).** What changes in teaching, offline
...
**[Learned methods](learned-methods.md).** What changes in imitation learning,
...
[task catalogue](when-two-arms-help.md#5-the-tasks-two-arms-are-asked-to-do), and
...
[The feedback control section](programmed-methods.md#5-feedback-control-and-the-closed-chain) works
through how.
...
[the one-arm overview](../one-arm-training/overview.md#3-the-four-layers-of-an-arm-system):
...
[no open implementation exists](programmed-methods.md#5-feedback-control-and-the-closed-chain).
...
[the one-arm overview](../one-arm-training/overview.md#10-what-you-can-realistically-do-in-the-next-year)
...
Next: [programmed methods](programmed-methods.md) for what changes in the
classical stack, or [learned methods](learned-methods.md) for where the two-arm
results actually are. If you have not yet decided whether your task needs two arms,
go back to [when two arms are really useful](when-two-arms-help.md).
