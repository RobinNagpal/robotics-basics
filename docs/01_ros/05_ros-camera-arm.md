...
The [camera example](03_ros-camera.md) found a ball in the camera's pictures, and
the [arm example](04_ros-arm.md) moved an arm by publishing its joint angles. This
...
The [camera basics](../05_camera/01_basics.md#3-what-a-picture-loses) explain that
...
The ball in the [camera doc's picture](03_ros-camera.md#1-the-two-programs) is at
...
positive, as the [arm doc](04_ros-arm.md#1-the-arm) shows, so the follower publishes
...
[arm doc](04_ros-arm.md#6-the-gripper) explains, and robot_state_publisher needs a
...
the arm moving, as it does in the [arm doc](04_ros-arm.md#5-running-it).
...
the [arm doc](04_ros-arm.md#8-a-real-arm) explains. Three things do get harder.
...
- **How far away the ball is.** A picture only gives a direction, so this arm can
  ...
  [one-box intro](../05_camera/03_one-box-intro.md) shows how a direction and a distance
...
Previous: [ROS arm](04_ros-arm.md). Back to the [ROS intro](01_ros-intro.md).
