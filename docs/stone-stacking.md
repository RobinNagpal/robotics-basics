...
[two-arm doc](two-arm-manipulation.md), whichever your simulator already has.
...
[two-arm doc](two-arm-manipulation.md#1-what-the-second-arm-adds):
...
they compare, see
[ways to programme or train two arms](two-arm-training/overview.md).)
...
[two-arm doc's step 2](two-arm-manipulation.md#42-step-2-copy-demonstrations)
...
[full-training folder](full-training/overview.md) follows this route all the
...
- **Perception of plain grey rock.** No colour to threshold, little texture to
  ...
  [camera basics area](camera/finding-objects.md).
...
[two-arm manipulation doc](two-arm-manipulation.md), which lists the open
...
[camera area](camera/basics.md) covers the perception ideas it leans on, the
[arm area](arm/overview.md) the frames and transforms, and the
[ROS basics](ros/ros-basics.md) the actions and controllers that would drive it.
