...
This is phases 1 to 3 of the [overview](overview.md): the rig, the
...
[stone stacking doc](../stone-stacking.md#4-the-system-end-to-end) — segment the
...
Next: [training and evaluating](training-and-evaluating.md).
