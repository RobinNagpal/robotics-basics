...
[the single-arm versions](../one-arm-training/programmed-methods.md) of these
...
[the task catalogue](when-two-arms-help.md#5-the-tasks-two-arms-are-asked-to-do).
...
With two arms the appeal of [TAMP](../one-arm-training/programmed-methods.md#5-task-and-motion-planning)
